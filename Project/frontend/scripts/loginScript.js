const users = [
    ...
    { email: "ali.mcheick@concordia.ca", password: "password123", role: "student", id: 40208790, name: "Ali Mcheick" },
    { email: "joe.valcourt@concordia.ca", password: "password123", role: "student", id: 40224909, name: "Joe Valcourt" },
    { email: "vladimir.shterenkiker@concordia.ca", password: "password123", role: "student", id: 40158317, name: "Vladimir Shterenkiker" },
    { email: "samuel.vachon@concordia.ca", password: "password123", role: "student", id: 40281580, name: "Samuel Vachon" },
    { email: "harish.thandayutham@concordia.ca", password: "password123", role: "student", id: 40250042, name: "Harish Thandayutham" },
    { email: "reuven.minciotti@concordia.ca", password: "password123", role: "student", id: 40252872, name: "Reuven Minciotti" }
];
